...
namespace NexusCore.BigControls
{
    public partial class TypeSelectorItem : UserControl {
        ...
        public TypeSelectorItem(Type type, string icon) : this() {
            this.type = type;
            btn.Text = type.Name;
            if (File.Exists(@"C:\Users\q.croes\source\repos\NexusOld\NexusCore\Icons\" + icon)) {
                btn.Image = ResizeImage(Image.FromFile(@"C:\Users\q.croes\source\repos\NexusOld\NexusCore\Icons\" + icon), 50, 50);
