...
public partial class PadocQuantumContextInMemory : PadocQuantumContext {
    public PadocQuantumContextInMemory() {
    }

    public PadocQuantumContextInMemory(DbContextOptions<PadocQuantumContext> options)
        : base(options) {
    }
