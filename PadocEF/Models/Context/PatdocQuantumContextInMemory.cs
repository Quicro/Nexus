...
public partial class PatdocQuantumContextInMemory : PatdocQuantumContext {
    public PatdocQuantumContextInMemory() {
    }

    public PatdocQuantumContextInMemory(DbContextOptions<PatdocQuantumContext> options)
        : base(options) {
    }
